...
var SpeechConnectionFactory = /** @class */ (function (_super) {
    ...
    function SpeechConnectionFactory() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.interactiveRelativeUri = "/voice.qhkly.com:20443/speech/recognition/interactive/cognitiveservices/v1";
        _this.conversationRelativeUri = "/voice.qhkly.com:20443/speech/recognition/conversation/cognitiveservices/v1";
        _this.dictationRelativeUri = "/voice.qhkly.com:20443/speech/recognition/dictation/cognitiveservices/v1";
        _this.create = function (config, authInfo, connectionId) {
...
//            var host = config.parameters.getProperty(Exports_3.PropertyId.SpeechServiceConnection_Host, "wss://" + location.host);
            var host = config.parameters.getProperty(Exports_3.PropertyId.SpeechServiceConnection_Host, "wss:/");
            var queryParams = {};
...
var ServiceRecognizerBase = /** @class */ (function () {
    ...
    ServiceRecognizerBase.prototype.sendWaveHeader = function (connection) {
        return connection.send(new SpeechConnectionMessage_Internal_1.SpeechConnectionMessage(Exports_2.MessageType.Binary, "audio", this.privRequestSession.requestId, "audio/x-wav", this.audioSource.format.header));
    };
...
var System = /** @class */ (function () {
    function System() {
        ...
        var SPEECHSDK_CLIENTSDK_VERSION = "1.9.1";
        this.name = "SpeechSDK";
...
var DialogServiceAdapter = /** @class */ (function (_super) {
    ...
    DialogServiceAdapter.prototype.sendWaveHeader = function (connection) {
        return connection.send(new SpeechConnectionMessage_Internal_1.SpeechConnectionMessage(Exports_2.MessageType.Binary, "audio", this.privDialogRequestSession.requestId, null, this.audioSource.format.header));
    };
    // Establishes a websocket connection to the end point.
